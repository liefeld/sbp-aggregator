...
The [Repositories](repos) page lists all public repositories across these organizations, with key metrics including star counts, last activity, primary language, and license. The data is refreshed nightly via a GitHub Actions workflow that queries the GitHub API and updates the site automatically.

## Getting Started

- Browse the **[Repositories](repos)** page to search, sort, and filter across all organizations at once.
- Click any repository name to go directly to its GitHub page.
- Use the search box to find repos by name, description, or language.
